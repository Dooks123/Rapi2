    ...
    public sealed class RemoteDirectoryInfo : RemoteFileSystemInfo
    {
        ...
        public RemoteDirectoryInfo Parent
        {
            get
            {
                ...
                return new RemoteDirectoryInfo(Device, directoryName);
            }
        }
        ...
        public RemoteDirectoryInfo Root
        {
            get
            {
                return new RemoteDirectoryInfo(Device, @"\");
            }
        }
        ...
        public void Create()
        {
            RemoteDirectory.CreateDirectory(Device, FullPath);
        }
        ...
        {
            return RemoteDirectory.CreateDirectory(Device, Path.Combine(FullPath, path));
        }
        ...
        {
            RemoteDirectory.Delete(Device, FullPath, false);
        }
        ...
        {
            RemoteDirectory.Delete(Device, FullPath, recursive);
        }
        ...
        {
            string[] ret = RemoteDirectory.GetDirectories(Device, FullPath, searchPattern);
            return Array.ConvertAll(ret, delegate (string s) { return new RemoteDirectoryInfo(Device, s); });
        }
        ...
        {
            string[] ret = RemoteDirectory.GetFiles(Device, FullPath, searchPattern);
            return Array.ConvertAll(ret, delegate (string s) { return new RemoteFileInfo(Device, s); });
        }
        ...
        {
            RemoteDirectory.Move(Device, FullPath, destDirName);
        }
